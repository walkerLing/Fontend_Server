    ...
    <div id="CT">
      <div id="CT_image">
        ...
        <div class="demo-image__preview1">
            ...
            <div class="img_info_1" style="border-radius: 0 0 20px 20px">
      ...
      <div id="info_patient">
        <!-- 卡片放置表格 -->
        <el-card style="border-radius: 30px;background-color: rgba(20, 177, 212,0.2);">
          <div slot="header" class="clearfix">
            <span id="fonts" >检测目标</span>
            <el-button
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检测到的目标" name="first" id="fonts">
              <!-- 表格存放特征值 -->
              <el-table
                :data="feature_list"
                height="390"
